...
if (BABYLON.Engine.isSupported() && !window.mobileAndTabletcheck()) {
    ...
    BABYLON.SceneLoader.Load("assets/3D/scene/", "scene.babylon", engine, function(newScene) {
        ...
        newScene.executeWhenReady(function() {
            ...
            var headTask = loader.addMeshTask("head", "", "assets/3D/models/head/", "model_mesh.obj");
            ...
            var channel1 = new TVChannel(game, "assets/3D/video/jukebox.mp4");
            var channel2 = new TVChannel(game, "assets/3D/video/musicmuseum.mp4");
            var channel3 = new TVChannel(game, "assets/3D/video/Team Carbon Frag Video.mp4");
