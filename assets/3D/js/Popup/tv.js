function Tv(game, mesh) {
	...
	this.channelNum = 0;
	this.lastChannel = 0;
	// this.offTexture = new BABYLON.VideoTexture("video", ["assets/3D/video/screen.mp4"], game.scene, true);; 
...
Tv.prototype.init = function() {
	this.addChannel(new TVChannel(this.game, "assets/3D/video/screen.mp4"));
